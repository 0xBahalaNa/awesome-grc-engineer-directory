...
company: "Robinhood"
slug: "greenhouse-robinhood-7884021-ethics-and-compliance-lead"
status: "published"
source: "Greenhouse"
sources:
  - "Greenhouse"
...
<p>Robinhood's Compliance Team is committed to operating with the highest standards of integrity and ethics across the company. The team partners closely with legal, people, and business teams to support compliant and ethical decision-making. You will help reinforce a culture where employees feel supported in raising concerns and navigating complex situations. We are seeking an experienced professional who is passionate about ethics and compliance to help strengthen this work!</p>
<p>As the Ethics &amp; Compliance Lead, you will develop and oversee Robinhood’s Ethics Office and Integrity Helpline. You will guide employees on conflicts of interest, interpret and apply the Code of Conduct, and support investigations into potential policy or regulatory violations. This role partners with legal, compliance, and business teams to manage Ethics Office initiatives, improve policies and processes, and support training and communications related to ethical conduct. You will also monitor risks, track program effectiveness, and provide reporting to leadership and the Board.</p>
<p><strong>This role is based in our Menlo Park, CA; New York, NY; or Washington, DC office(s), with in-person attendance expected 3 days per week.</strong></p>
...
<p><span style="text-decoration: underline;">Base Pay Range:</span></p></div><div class="title">Zone 1 (Menlo Park, CA; New York, NY; Bellevue, WA; Washington, DC)</div><div class="pay-range"><span>$145,000</span><span class="divider">&mdash;</span><span>$170,000 USD</span></div></div><div class="pay-input"><div class="title">Zone 2 (Denver, CO; Westlake, TX; Chicago, IL)</div><div class="pay-range"><span>$128,000</span><span class="divider">&mdash;</span><span>$150,000 USD</span></div></div><div class="pay-input"><div class="title">Zone 3 (Lake Mary, FL; Clearwater, FL; Gainesville, FL)</div><div class="pay-range"><span>$113,000</span><span class="divider">&mdash;</span><span>$133,000 USD</span></div></div></div><div class="content-conclusion"><p>Click <a href="https://careers.robinhood.com/benefits" target="_blank">here</a> to learn more about our Total Rewards, which vary by region and entity.</p>
