...
linkedin: https://www.linkedin.com/in/ethantroy/
twitter: "@ethanolivertroy"
bluesky: ethantroy.com
blog: https://ethantroy.dev/
huggingface: ethanolivertroy
...
projects:
  - name: fedramp-docs-mcp
    ...
    description: MCP server for FedRAMP documentation
  - name: claude-grc-agent-demo
    url: https://github.com/ethanolivertroy/claude-grc-agent-demo
    description: Domain-specific GRC agent built with the Claude Agent SDK
  - name: nmap-GPT
    url: https://github.com/ethanolivertroy/nmap-GPT
    description: AI-powered Nmap scanner that provides security insights on open ports
  - name: DamnVulnerableTrustCenter
    url: https://github.com/ethanolivertroy/DamnVulnerableTrustCenter
    description: Intentionally vulnerable trust center for security awareness
  - name: hackidle-nist-coder
    url: https://ollama.com/etgohome/hackidle-nist-coder
    description: Fine-tuned model for NIST security and compliance coding tasks
